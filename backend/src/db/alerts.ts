...
const AlertSchema = new mongoose.Schema({
    ...
    eventTime: {type: Date, required: false}, // Time of event
    eventLocation: {type: String, required: false}, // Location of event
    eventImage: {type: String, required: false}, // Splash image of event
